			...
			<div className="p-2 border-t">
				<div className="flex items-center gap-2">
					<textarea
						...
						placeholder={autoEdit ? "Describe what you want AI to edit in your document..." : "Enter a prompt here"}
						disabled={loading}
					/>
					<button
						onClick={handleSend}
				...
				{autoEdit && (
					<div className="text-xs text-gray-500 mt-1 px-1">
						💡 Try: "Make this more professional", "Add bullet points", "Fix grammar", etc.
					</div>
				)}
			</div>
		</div>
